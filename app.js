...
*/
app.get('/adithya', function(request, response) {
    //response.send("<h2><center>Welcome to Node JS app</h2>");
    response.write("<h2><center><u>Node JS  Application </u></center></h2>");
	
    response.write("<h2><center>Welcome to  Adithya. Please Contact +91-9491785919 for more information or send an email to adithyaacgacg3@gmail.com <center></h2>" );
    response.end();
